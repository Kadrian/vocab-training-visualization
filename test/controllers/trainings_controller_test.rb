...
class TrainingsControllerTest < ActionController::TestCase
  ...
  test "should create training" do
    assert_difference('Training.count') do
      post :create, training: { time: @training.time, training_number: @training.training_number, trials: @training.trials, word,: @training.word, }
    end
  ...
  test "should update training" do
    patch :update, id: @training, training: { time: @training.time, training_number: @training.training_number, trials: @training.trials, word,: @training.word, }
    assert_redirected_to training_path(assigns(:training))
  end
